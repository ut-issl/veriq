...
from veriq._path import AttributePart, CalcPath, ModelPath, ProjectPath, VerificationPath


class TestNodeSpec:
    """Tests for NodeSpec dataclass."""

    def test_model_node_is_input(self) -> None:
        node = NodeSpec(
    ...
    def test_calculation_node_is_not_input(self) -> None:
...
class TestGraphSpec:
    ...
    def test_empty_graph_spec(self) -> None:
        spec = GraphSpec()
        assert len(spec) == 0
    ...
    def test_get_nodes_by_kind(self) -> None:
        model_path = ProjectPath(scope="Test", path=ModelPath(root="$", parts=(AttributePart("x"),)))
...
class TestBuildGraphSpec:
    """Tests for build_graph_spec function."""

    def test_simple_model_only(self) -> None:
    ...
    def test_model_with_verification(self) -> None:
    ...
    def test_verification_xfail_metadata(self) -> None:
    ...
    def test_multi_scope_project(self) -> None:
